let url = "https://turtle-apis.onrender.com";
const { get } = require('axios'), fs = require('fs');
let f = __dirname+'/cache/34dr.png';
...
module.exports = {
  config: {
    name: "jee",
  	...
  	hasPermssion: 0,
    credits: "Zetsu",
	  description: "Generate image in 56 models",
  ...
  run: async function({api, event, args}){
    ...
    try {
    const d = (await get(url+'/api/prodia?prompt='+b+'&model='+c, {
